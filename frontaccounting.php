...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	include_once($path_to_root . '/applications/jobwork.php');
	include_once($path_to_root . '/applications/tds.php');
	include_once($path_to_root . '/applications/plant_maintenance.php');
	...
	include_once($path_to_root . '/applications/service.php');
	...
	class front_accounting
	{
		...
		function init()
		{
			...
			$this->add_application(new inventory_app());
			 $this->add_application(new jobwork_app());
			//$this->add_application(new tds_app());
			$this->add_application(new plant_maintenance_app());
			...
			//$this->add_application(new service_app());
